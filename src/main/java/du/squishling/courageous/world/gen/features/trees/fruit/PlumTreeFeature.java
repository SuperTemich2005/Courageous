...
public class PlumTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    private static final BlockState DEFAULT_LEAF = ModBlocks.PLUM_LEAVES.getDefaultState().with(HarvestableLeaves.GROWN, false).with(LeavesBlock.PERSISTENT, false);
    protected final int minTreeHeight;
    private final boolean vinesGrow;
    private final BlockState trunk;
    private final BlockState leaf;

    public PlumTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
        this(configFactoryIn, false, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }

    public PlumTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyOnPlace, int minTreeHeightIn, BlockState trunkState, BlockState leafState, boolean vinesGrowIn) {

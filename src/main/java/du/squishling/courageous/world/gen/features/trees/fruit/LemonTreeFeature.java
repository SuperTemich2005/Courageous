...
public class LemonTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public LemonTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
        this(configFactoryIn, false, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }

    public LemonTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyOnPlace, int minTreeHeightIn, BlockState trunkState, BlockState leafState, boolean vinesGrowIn) {
        ...
        this.setRegistryName(Reference.MOD_ID, "lemon_tree");

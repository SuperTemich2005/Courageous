...
public class AvocadoTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public AvocadoTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
        this(configFactoryIn, false, 4, DEFAULT_TRUNK, DEFAULT_LEAF, false);
    }

    public AvocadoTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyOnPlace, int minTreeHeightIn, BlockState trunkState, BlockState leafState, boolean vinesGrowIn) {
        ...
        this.setRegistryName("avocado_tree");

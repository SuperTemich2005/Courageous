...
public class AppleTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public AppleTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyOnPlace, int minTreeHeightIn, BlockState trunkState, BlockState leafState, boolean vinesGrowIn) {
        ...
        this.setRegistryName("apple_tree");
